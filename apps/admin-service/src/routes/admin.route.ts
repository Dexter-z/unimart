...
import { addNewAdmin, getAllAdmins, getAllCustomizations, getAllEvents, getAllProducts, getAllSellers, getAllUsers, getCategories, addCategory, addSubCategory, deleteCategory, deleteSubCategory, uploadLogo, uploadBanner, getAllNotifications, getAllUsersNotifications, markAdminNotificationAsRead, markAdminNotificationAsUnread } from "../controllers/admin.controller";
...
router.post("/mark-admin-notification-as-unread", isAdminAuthenticated, markAdminNotificationAsUnread);

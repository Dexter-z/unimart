            ...
            cell: ({ row }: { row: { original: Product } }) => {
                ...
                return (
                    <div className="flex gap-3">
                        ...
                        <Link href={`/product/edit/${row.original.id}`} className='text-yellow-400 hover:text-yellow-300 transition-colors duration-200'>
                            <Pencil size={18} />
                        </Link>
    ...
    return (
        <div className="p-4 sm:p-6 bg-black min-h-screen">
            <div className="mb-4 sm:mb-6">
                ...
                <p className="text-gray-400 mt-1 text-sm sm:text-base">Manage and track all your products</p>
            </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-2">
                            ...
                            <Link
                                ...
                                className='bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm whitespace-nowrap'
                            >
                                            ...
                                            <div key={row.id} className="px-4 py-4 hover:bg-blue-900 transition-colors duration-200">
                                                ...
                                                <div className="grid grid-cols-2 gap-3 text-sm mt-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className={`ml-1 ${product.stock <= 10 ? 'text-red-400' : 'text-white'}`}>
                                                            {product.stock} left
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="flex justify-between items-center pt-3 mt-3 border-t border-gray-800">
                                                    <div className="flex gap-3">
                                                        ...
                                                        <button
                                                            className='text-green-400 hover:text-green-300 transition-colors duration-200 p-2'
                                                            title="View Analytics"
                                                        >
                                                            <BarChart size={18} />
                                                        </button>
            ...
            <Sheet open={showDeleteModal} onOpenChange={setShowDeleteModal}>
                <SheetContent side="bottom" className="max-w-md mx-auto rounded-t-lg bg-black border-gray-800 md:max-w-lg">
